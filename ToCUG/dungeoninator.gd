...
func mark_room_centers():
	var room_center # tile coordinates of the center of the room locally to self
	var room_center_position: Vector2
	#var neighbor_room
	#var neighbor_room_center
	#var neighbor_room_center_position: Vector2
	var connected_room_center: Vector2  # tile coordinates of the center of the connected room locally to self
	var connected_room_center_position: Vector2
	for room in rooms:
